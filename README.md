...
> **Сначала назначьте клавишу.** В Minecraft: `Настройки` → `Управление` → категория
> **openGlasses** → **Free Cursor (Toggle)**. **По умолчанию она не назначена**, и пока вы
> её не забиндите, никакой ввод из очков работать не будет — это ограничение мода
> OCGlasses, а не приложения.

Нажимаете эту клавишу (в надетых очках) — появляется курсор. Дальше:

| Действие | Что делает |
|---|---|
| Клик по **‹** / **›** на панели | Предыдущий / следующий источник |
| Клик по названию источника | Включить/выключить циклический перебор (`⟳` рядом с названием) |
| **←** / **→** | То же, что ‹ / › |
| **1**…**9** | Выбрать источник по номеру из списка Buffers |
| **C** | Включить/выключить циклический перебор |
| **Esc** | Закрыть курсор |
